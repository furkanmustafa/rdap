...
- (void)writeString:(NSString*)string {
	[self writeString:string withTag:0];
}
- (void)writeString:(NSString*)string withTag:(long)tag {
	[self writeString:string withTimeout:-1 withTag:tag];
}
- (void)writeString:(NSString*)string withTimeout:(NSTimeInterval)timeout withTag:(long)tag {
	[self writeData:[string dataUsingEncoding:NSUTF8StringEncoding] withTimeout:timeout tag:tag];
}
